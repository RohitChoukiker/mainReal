...
export const LoginPopup: React.FC<LoginPopupProps> = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log("Login Data:", { id, email, password, role });
  ...
  return (
    ...
    >
      <motion.div
        ...
        className={`rounded-xl max-w-md w-full p-8 relative ${
          isDarkMode ? "bg-gray-800 text-white" : "bg-primary text-primary"
        }`}
