...
const aboutFeatures: Feature[] = [
  {
    ...
    description: "Automate and simplify your transaction processes",
  },
  {
    icon: Shield,
...
const services: Service[] = [
  {
    ...
    description:
      "Comprehensive tools for agents to manage deals from start to finish",
    features: [
      "Document Management",
      "Timeline Tracking",
  ...
  },
  {
    ...
    description:
      "Streamlined coordination and compliance tracking for Transaction Coordinators",
    features: ["Task Automation", "Compliance Checks", "Deadline Management"],
  },
  {
    icon: BarChart3,
    title: "Brokerage Oversight",
    description:
      "Advanced analytics and oversight tools for administrative staff",
    features: ["Performance Metrics", "Risk Assessment", "Financial Tracking"],
  },
];
...
const team: TeamMember[] = [
  {
    ...
    role: "Developer",
    image:
      "https://media.licdn.com/dms/image/v2/D5603AQFHN8m-zpDK3w/profile-displayphoto-shrink_400_400/B56ZVsCkr6HoAg-/0/1741274369372?e=1747267200&v=beta&t=8Wec9qTty1_UQ9XJVQS_SRYgF3KCy7eYveBAIU1Sy6k",
    social: {
      linkedin: "https://www.linkedin.com/in/rohit-choukiker",
      twitter: "#",
    },
  },
];
  ...
  return (
    <motion.nav
      ...
      className={`fixed w-full z-50 transition-all duration-300 ${
        isScrolled
          ? "bg-secondary/0 shadow-theme backdrop-blur-md"
          : "bg-transparent"
      }`}
    >
        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="md:hidden flex items-center space-x-2">
            <motion.button
              onClick={() => setIsDarkMode(!isDarkMode)}
              className={`p-2 rounded-full ${
                isScrolled ? "bg-secondary" : "bg-white/10"
              }`}
            >
              <AnimatePresence mode="wait">
                {isDarkMode ? (
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-subheading max-w-2xl mx-auto">
            We're revolutionizing real estate transaction management with
          ...
          {aboutFeatures.map((feature, index) => {
            ...
            return (
              <motion.div
                ...
                className="card p-6"
              >
                <div className="accent-primary mb-4">
    ...
    <section id="services" className="section">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-subheading max-w-2xl mx-auto">
            Comprehensive solutions tailored for every role in real estate
              ...
              >
                <div className="relative transform-style-3d transition-transform duration-500 group-hover:rotate-y-180">
                  <div className="card p-8">
                    <div className="accent-primary mb-6">
                      <Icon className="w-12 h-12" />
                    </div>
      ...
      >
        ...
        <div className="p-8">
          ...
          >
            ...
            <p className="text-subheading max-w-2xl mx-auto">
              Meet the passionate individuals driving innovation in real estate
              technology.
            </p>
          </motion.div>
            ...
            {plans.map((plan, index) => (
              <motion.div
                ...
                className={`relative card overflow-hidden ${
                  plan.popular ? "ring-4 ring-accent-primary" : ""
                }`}
              >
                {plan.popular && (
                ...
                <div className="p-8">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className={`w-full button mb-8 ${
                      plan.popular ? "" : "bg-secondary text-primary"
                    }`}
                  >
                    Get Started
                  </motion.button>
    ...
    <section id="contact" className="section bg-primary min-h-screen">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <motion.div
          ...
          className="text-center mb-16"
        >
          <h2 className="text-heading mb-4 bg-gradient-theme bg-clip-text text-transparent">
            Get in Touch
          </h2>
          <p className="text-subheading max-w-2xl mx-auto">
            We'd love to hear from you. Drop us a line and we\'ll get back to
            you shortly.
          </p>
        </motion.div>
            ...
            <div className="card p-8">
              ...
              <div className="space-y-8">
                <div className="flex items-center space-x-4 group">
                  <div className="bg-secondary p-4 rounded-2xl group-hover:bg-primary">
                    <Phone className="w-6 h-6 accent-primary" />
                  </div>
                  <div className="transform group-hover:translate-x-1">
                    <p className="text-sm text-secondary">Call Us</p>
                    <p className="text-primary font-medium">+91 8989898989</p>
                  </div>
                </div>
                <div className="flex items-center space-x-4 group">
                  <div className="bg-secondary p-4 rounded-2xl group-hover:bg-primary">
                    <Mail className="w-6 h-6 accent-primary" />
                  </div>
                  <div className="transform group-hover:translate-x-1">
                    <p className="text-sm text-secondary">Email Us</p>
                    <p className="text-primary font-medium">
                      rohitchoukiker21@gmail.com
                    </p>
                  </div>
                </div>
                <div className="flex items-center space-x-4 group">
                  <div className="bg-secondary p-4 rounded-2xl group-hover:bg-primary">
                    <MapPin className="w-6 h-6 accent-primary" />
                  </div>
                  <div className="transform group-hover:translate-x-1">
                    <p className="text-sm text-secondary">Visit Us</p>
                    <p className="text-primary font-medium">
              ...
              <div className="mt-12 pt-8 border-t border-theme">
                ...
                <div className="flex space-x-6">
                  <a
                    href="#"
                    className="bg-secondary p-4 rounded-2xl hover:bg-primary"
                  >
          ...
          >
            <div className="space-y-8">
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="w-full button flex items-center justify-center space-x-2"
              >
    ...
    <footer className="bg-primary text-secondary py-12">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <p className="text-secondary">
              Streamlining real estate transactions with innovative technology
              solutions.
            </p>
          </div>
          <div>
        ...
        <div className="border-t border-theme pt-8 flex justify-between items-center">
          <p className="text-secondary">
            © {new Date().getFullYear()} Real Estate Manager. All rights
            reserved.
          </p>
          <motion.button
            onClick={scrollToTop}
            whileHover={{ y: -5 }}
            className="button p-3 rounded-full"
          >
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <h1 className="text-6xl md:text-8xl font-bold mb-6 leading-tight tracking-tight">
              Revolutionize Your
              <br />
              <span className="text-transparent bg-clip-text bg-gradient-theme">
                Real Estate Journey
              </span>
            </h1>
            <p className="text-xl md:text-2xl mb-10 text-secondary max-w-3xl mx-auto leading-relaxed">
              Transform your real estate transactions with our cutting-edge,
              user-friendly platform designed for seamless efficiency.
            </p>
            <motion.button
              whileHover={{ scale: 1.1, y: -5 }}
              whileTap={{ scale: 0.98 }}
              onClick={() => setShowLoginPopup(true)}
              className="button inline-flex items-center gap-3 px-8 py-4 text-lg font-bold shadow-md hover:shadow-lg rounded-lg"
            >
              Login <ArrowRight className="w-6 h-6 animate-pulse" />
            </motion.button>
          </motion.div>
        </div>
      </section>
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Revolutionize your real estate journey"
        />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <div
        className={`min-h-screen ${
          isDarkMode ? "bg-gray-900 text-white" : "bg-primary text-primary"
        }`}
      >
        <Navbar
        ...
        <AnimatePresence>
          ...
          {showTeamPopup && (
            <TeamPopup onClose={() => setShowTeamPopup(false)} />
          )}
          {showLoginPopup && (
            <LoginPopup
