...
export default function TestApproveAgentPage() {
  ...
  const approveAgent = async () => {
    ...
    try {
      ...
      const response = await fetch("/api/test/approve-agent", {
        method: "POST",
        headers: {
  ...
  return (
    <div className="container mx-auto py-10">
      <Card>
        <CardHeader>
          <CardTitle>Test Agent Approval</CardTitle>
          <CardDescription>
            This is a test tool to directly approve an agent by ID.
          </CardDescription>
        </CardHeader>
