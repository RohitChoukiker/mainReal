...
export default function TeamModal({ onClose }: TeamModalProps) {
  const teamMembers = [
    ...
    },
    {
      ...
      bio: "Michael oversees product development, ensuring our platform meets the evolving needs of real estate professionals based on industry trends and user feedback.",
      image: "/images/team-3.jpg",
    },
    {
      name: "Emily Davis",
      role: "Customer Success Manager",
      bio: "Emily leads our customer success team, helping clients maximize the value of our platform through training, support, and strategic guidance.",
      image: "/images/team-4.jpg",
    },
    {
      name: "David Wilson",
      role: "Sales Director",
      bio: "David brings 12+ years of real estate sales experience to help brokerages and agents find the right solutions for their transaction management needs.",
      image: "/images/team-5.jpg",
    },
    {
      name: "Jennifer Martinez",
      role: "Marketing Manager",
      bio: "Jennifer develops and executes our marketing strategy, showcasing how our platform helps real estate professionals save time and reduce stress.",
      ...
      >
        ...
        <div className="p-6">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 mt-2">Meet the talented people behind RealEstate Pro</p>
          </div>
          ...
          <div className="mt-10 text-center">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              We're always looking for talented individuals to join our team. If you're passionate about real estate and
              technology, check out our open positions.
            </p>
            <button
              type="button"
